        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.create.waiter') }}">
                            @csrf
                            <div class="row mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/users/'.$user->id.'/edit') }}"><button type="button"
                                                    class="btn btn-outline-warning btn-sm">Editar</button></a>
                                            @if (!$user->admin)
                                                <a href="{{ url('/admin/users/'.$user->id.'/delete') }}"><button type="button"
