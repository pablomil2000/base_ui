...
<head>
    ...
    <title>Piccolo Automóviles</title>
    ...
    <div class="container">
        ...
        ================================================== -->
            <div class="span5 logo">
                ...
                <h5>Subastas de coches de tamaño reducido</h5>
            </div>
    ...
    ================================================== -->
        ...
        ================================================== -->
                <div class="span4 sidebar page-sidebar">
                    ...
                    <h5 class="title-bg">Nosotros</h5>
                    <address>
                        <strong>Piccolo</strong><br>
                        Avenida de la Arboleda<br>
                        Lepe, Huelva<br>
                    </address>

                    <address>
                        <strong>Departamento de Informática</strong><br>
                        <a href="mailto:#">manuela.cordero@ieslaarboleda.com</a>
                    </address>
