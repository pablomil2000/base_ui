...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?= $this->include('images/favicon.png.base64'); ?>">
        <style><?= $this->include('css/exception.css'); ?></style>
        <style><?= $this->include('css/exception_full.css'); ?></style>
    </head>
    <body>
        <script>
        ...
        <?php if (class_exists(\Symfony\Component\HttpKernel\Kernel::class)) { ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?= $this->include('images/symfony-logo.svg'); ?> Symfony Exception</h1>

                    <div class="help-link">
                        <a href="https://symfony.com/doc/<?= Symfony\Component\HttpKernel\Kernel::VERSION; ?>/index.html">
                            <span class="icon"><?= $this->include('images/icon-book.svg'); ?></span>
